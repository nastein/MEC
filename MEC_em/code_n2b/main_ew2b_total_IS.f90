program em_2body
   ...
   integer*4 :: nw,nev,i,xA,total_isospin,i_fg,nq,nenu,iq,ie,i_fsi
   integer*4 :: nwlk=256!144
...
!   call bcast(cos)   
  ...
  ! call bcast(ne)
   ...
   call mc_init(i_fg,pwia,i_fsi,irn,nev,nwlk,xpf,thetalept,xmpi,xmd,xmn,xA,total_isospin,nk_fname)
...
!...this is for the total xsec
   ...
   do i=1,nw
      ...
      if (myrank().eq.0) then
         write(6,*)w, sig, sig_err
         write(7,*)w, sig, sig_err
         flush(7)
      endif
   enddo
   close(7)
